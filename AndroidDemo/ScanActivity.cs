...
namespace XamarinScanditSDKDemoAndroid
{
	...
	public class ScanActivity : Activity, IOnScanListener, IDialogInterfaceOnCancelListener
	{
		...
		public static string appKey = "Rd5Ut0Zxo17jczBspPtmN+/3c1cd933nhlZ6TYdN55U";		
		...
		public void DidScan(IScanSession session) 
		{
			if (session.NewlyRecognizedCodes.Count > 0) {
				...
				Console.WriteLine ("Código escaneado: {0}, '{1}'", code.SymbologyName, code.Data);
				...
				RunOnUiThread (() => {
					AlertDialog alert = new AlertDialog.Builder (this)
						.SetTitle (code.SymbologyName + " Código de barras detectado")
